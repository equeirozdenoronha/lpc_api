...
class TipoInscricaoResource(ModelResource):
    class Meta:
        ...
        authorization = Authorization()#permissão para qualquer pessoa fazer requisições para esta api
        filtering = {
...
class InscricaoResource(ModelResource):
    pessoafisica = fields.ToOneField(PessoaFisicaResource, 'pessoa') # ToOneField = de 1 pra 1 toManyField = de 1 pra muitos
